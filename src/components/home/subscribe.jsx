...
const sub = '/public/assets/img/backgroundImages/subscribe.jpg'
...
export default function Subscribe() {
  ...
  return (
    <motion.div
      ...
      className="w-[85vw] md:w-[75vw] lg:w-[65vw] xl:w-[60vw] mx-auto -mt-20 relative overflow-hidden rounded-xl shadow-lg"
    >
      ...
      <div className="flex flex-col md:flex-row items-center relative z-10">
        ...
        <div className="w-full md:w-1/2 p-6 md:p-8">
          ...
          >
            ...
            <p className="text-xs text-white/80 mt-3 leading-relaxed font-light max-w-sm">
