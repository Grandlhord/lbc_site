...
function Podcast() {
  ...
  const platforms = [
    ...
    { name: "Apple Podcasts", icon: apply, url: "https://podcasts.apple.com" },
  ]
          ...
          <motion.div ref={platformsRef} className="w-full">
            ...
            >
              {platforms.map((platform, index) => (
                ...
                >
                  <div className="p-4 rounded-full bg-gray-800 bg-opacity-50 backdrop-blur-sm mb-2 transition-all duration-300 group-hover:bg-gray-700 group-hover:shadow-lg group-hover:shadow-purple-500/20">
                    <motion.img
