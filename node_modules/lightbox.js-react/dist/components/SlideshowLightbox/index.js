...
// esbuild-css-modules-plugin-namespace:C:\Users\silvi\AppData\Local\Temp\tmp-8164-nT2XvhnSKVIq\lightbox.js-react\src\components\SlideshowLightbox\SlideshowLightbox.module.css.js
var digest = "9d73527626f8a8a1042de989c031b5cbe703d01619b535abb35afcabe77b8abe";
var css = `._lightboxjs_1iakc_1 {
    margin: 0;
    padding: 0;
  }
  ...
  ._slideshowBtn_1iakc_55 {
    padding-bottom: 2px;
  }
  
  ._closeIcon_1iakc_63:hover,
  ._closeIcon_1iakc_63:focus,
  ._iconsHeader_1iakc_67 svg:hover,
  ._iconsHeader_1iakc_67 svg:focus,
  ._prev1_1iakc_71 span:hover,
  ._next1_1iakc_73:hover,
  ._icon_1iakc_67:hover {
  ...
  ._prevIcon_1iakc_89:hover,
  ._nextIcon_1iakc_91:hover {
  ...
  ._displayHidden_1iakc_109 {
    display: none;
  }
  
  ._thumbnail_1iakc_117 {
    opacity: 1;
    transition: all 0.3s;
    cursor: pointer;
    position: relative;
  ...
  img._hoverShadow_1iakc_131 {
    transition: 0.3s;
  }
  
  ._hoverShadow_1iakc_131:hover {
  ...
  ._thumbnailsWithCaption_1iakc_187 {
    width: 90%;
  }
  
  ._navigationDots_1iakc_195 {
    display: flex;
    flex-direction: row;
    flex-wrap: wrap;
  }
  ...
  @media screen and (min-width: 20em) {
    ._imageSlide_1iakc_211 {
      height: 67vw;
      width: 60%;
    }

    ._thumbnailsOuterContainer_1iakc_221 {
      position: fixed;
      bottom: 5%;
      width: 100vw;
      /* width: 100%; */
    ...
    ._thumbnailsAndCaption_1iakc_235 {
      height: 23vh;
    }
  
    ._hideControlsBar_1iakc_243 ._slideshowImg_1iakc_243 {
      height: 100vh;
    }
  
    ._rotateImgInnerContainer_1iakc_251 {
      top: 8%;
    }
  
    ._hideControlsBar_1iakc_243 ._slideshowInnerContainer_1iakc_259 {
      top: 0;
    }
    ...
    ._videoThumbnailsOuterContainer_1iakc_279 {
      bottom: 2%;
    }
  
    ._imgTitleContainer_1iakc_287 {
      padding-bottom: 16px;
      width: 100vw;
      margin-top: 0;
      margin-bottom: 0;
  ...
  ._thumbnailsOuterContainerMetadata_1iakc_367 {
    width: 78vw;
  }
  ...
  ._htmlVideoOuterContainer_1iakc_391 video {
    height: 100%;
    max-height: 70vh;
    width: 100%;
  }
  ...
  ._galleryImg_1iakc_423 {
    cursor: pointer;
    margin: 0.2em;
  }
  
  ._modalContainer_1iakc_433 {
    width: 100vw;
    height: 100%;
    max-height: 100%;
    direction: ltr;
  ...
  ._slideshowAnimContainer_1iakc_471 {
    height: 100%;
    max-height: 100%;
    direction: ltr;
    overflow: hidden;
  ...
  ._fullScreenContainer_1iakc_507 img {
    height: 100vh;
    max-width: 100%;
    max-height: 100vh;
  }
  
  ._imageInnerContainer_1iakc_519 img {
    height: 80vh;
    max-width: 100%;
    max-height: 100%;
  }
  
  ._imageInnerContainer_1iakc_519 {
    position: fixed;
    display: flex;
  ...
  ._magnifyWrapper_1iakc_557 {
    margin-bottom: 3em;
    margin-left: auto;
    margin-right: auto;
  }
  
  ._slideshowInnerContainer_1iakc_259 {
    position: fixed; 
    display: flex;
    flex-direction: column;
    justify-content: center;
  ...
  ._slideshowInnerVideoContainer_1iakc_597 {
    top: 6%;
  }
  
  ._slideshowInnerContainerThumbnails_1iakc_605 {
    top: 12%;
  }
  
  ._hideControlsBar_1iakc_243  {
    top: 0;
  }
  
  ._fullScreenContainer_1iakc_507 {
    top: 0;
  }
  
  ._lightboxContainer_1iakc_629 {
    width: 100%;
    height: 100%;
    position: relative;
    display: flex;
  ...
  ._next1_1iakc_73:hover,
  ._prev1_1iakc_71:hover {
    color: rgb(230, 230, 230);
  }
  
  ._slideshowAnimImg_1iakc_701 {
    position: absolute;
    max-width: 100vw;
  }
  ...
  ._videoOuterContainer_1iakc_763 {
    width: 65%;
    margin-left: auto;
    margin-right: auto;
    height: 60vh;
  ...
  ._htmlVideoOuterContainer_1iakc_391 {
    width: 80%;
    margin-left: auto;
    margin-right: auto;
  }
  
  ._customVideoContainer_1iakc_791, ._customEmbedContainer_1iakc_791 {
    margin-left: auto;
    margin-right: auto;
  }
  
  ._videoIconsHeader_1iakc_801 {
    position: fixed;
    top: 4%;
    right: 3%;
  }
  
  ._lightbox_1iakc_1 ._iconsHeader_1iakc_67 svg {
    transition: 0.3s all;
  }
  
  ._iconsHeader_1iakc_67 svg:active {
  ...
  @media screen and (min-width: 42em) {
    ...
    ._innerContainerWithTopCaption_1iakc_1073 {
      top: 8%;
    }

    ._slideshowImgFullscreen_1iakc_1081 {
      display: grid;
      width: 92vw;
      place-items: start;
      margin-left: auto;
    ...
    ._slideshowInnerContainer_1iakc_259 img {
      margin-top: 0vh;
      /* width: 70vw; */
    }
    ...
    ._slideshowInnerContainerFullScreen_1iakc_1125 {
      top: 0%;
    }
  
    ._fullScreenLightboxImg_1iakc_1133 {
      margin-left: auto;
      margin-right: auto;
      height: 100vh;
    }

    ._slideshowInnerContainerImgMetadata_1iakc_1145 {
      display: flex;
      flex-direction: column;
      flex-wrap: wrap;
    ...
    ._slideshowInnerContainerFullScreen_1iakc_1125 img {
      object-fit: contain;
    }
    ...
    ._thumbnails_1iakc_171::-webkit-scrollbar {
      display: none; /* Safari and Chrome */
    }
  
    ._opacity-fade_1iakc_1199 {
    ...
    ._thumbnail_1iakc_117,
    ._imageSliderThumbnails_1iakc_1227 img {
      height: 10vh;
      /* width: 7em; */
    }
    ...
    ._slideshowImgMetadata_1iakc_1303 {
      width: 78vw;
    }
  
    ._prev1Metadata_1iakc_1311 {
      left: 1%;
    }
  ...
  @media screen and (min-width: 53em) {
    ...
    ._slideshowImgWithCaption_1iakc_1353 {
      height: 68vh;
    }
  
    ._hideControlsBar_1iakc_243 ._slideshowImg_1iakc_243, ._hideControlsBarAndCaption_1iakc_1361 ._slideshowImg_1iakc_243  {
      padding-top: 12vh;
    }

    ._fullScreenContainer_1iakc_507 ._slideshowImg_1iakc_243 {
      padding-top: 0vh;
    }
  
  
    ._lightboxImg_1iakc_1379 {
        /* height: 70vh; */
    }
  ...
  ._lightIcon_1iakc_1429,
  ._lightIcon_1iakc_1429 svg {
    background-color: white;
    color: black;
  }
  
  ._lightIcon_1iakc_1429:hover,
  ._lightIcon_1iakc_1429 svg:hover {
    background-color: white;
    color: black;
    fill: black;
  }
  
  ._darkIcon_1iakc_1455,
  ._darkIcon_1iakc_1455 svg {
  ...
  ._darkIcon_1iakc_1455:hover,
  ._darkIcon_1iakc_1455 svg:hover {
    color: rgba(107, 107, 107, 0.8);
    fill: rgba(107, 107, 107, 0.8);
  }
  
  /* Header icons  */
  ._lightHeaderIcon_1iakc_1485 svg {
    background-color: white;
    color: black;
    fill: black;
  }
  
  ._lightHeaderIcon_1iakc_1485 svg:hover {
    background-color: white;
  ...
  ._darkHeaderIcon_1iakc_1511 svg {
    background-color: transparent;
    /* background-color: #151515; */
    color: #626b77;
    fill: #626b77;
  ...
  ._darkHeaderIcon_1iakc_1511 svg:hover {
    color: rgba(99, 99, 99, 0.8);
    fill: rgba(99, 99, 99, 0.8);
  }
  
  ._magnifierImage_1iakc_1535 {
    object-fit: contain;
  }
  
  ._thumbnails_1iakc_171 ._active_1iakc_1543 {
    border: solid rgb(107, 133, 206) 2px;
  }
  
  ._inactiveThumbnailBorder_1iakc_1551 {
  ...
  ._reactTransformComponent_1iakc_1923 {
    margin-left: auto;
    margin-right: auto;
  }
  ...
  ._loader_1iakc_1945 {
    ...
    top: 50%;
    left: 50%;
    animation: _rotation_1iakc_1 1s linear infinite;
  }
  
  @keyframes _rotation_1iakc_1 {
    0% {
  ...
  ._dayLoader_1iakc_1991 {
    border: 5px solid #626b77;
    border-bottom-color: transparent;
  }
  
  ._nightLoader_1iakc_2001 {
  ...
  ._controls_1iakc_711 button, ._closeButton_1iakc_2023, ._closeButtonRounded_1iakc_2023 {
    background: none;
    border: none;
    padding: 0;
    cursor: pointer;
  ...
  ._controls_1iakc_711 svg {
    box-sizing: border-box;
  }
  
  ._closeButton_1iakc_2023 svg, ._closeButtonRounded_1iakc_2023 svg {
    box-sizing: border-box;
    font-size: 16px;
    padding-top: 0.5px;
  }
  
  ._closeButton_1iakc_2023 {
    padding-top: 3px;
  }
  
  ._closeButtonRounded_1iakc_2023 {
    cursor: pointer;
  
  }
  
  ._closeButtonRounded_1iakc_2023 svg {
    margin: 0;
    padding: 5px;
    background-color: black;
  ...
  ._slideImageAndCaption_1iakc_2117 {
    top: 9%;
  }
  
  ._slideImageAndCaption_1iakc_2117._hideControlsBar_1iakc_243 {
    top: 0;
  }
  ...
  ._roundedBorder_1iakc_2149 {
    border-radius: 20px;
  }
  
  ._maxWidthFull_1iakc_2157 {
    max-width: 100%;
  }
  
  ._maxWidthWithoutMagnifier_1iakc_2165 {
    max-width: 80%;
  }
  ...
  ._lightboxVideo_1iakc_2303 {
    margin-left: auto;
    margin-right: auto;
  }
 
  ._navigation-wrapper_1iakc_2313 {
    position: relative;
  }
  ...
  ._dot_1iakc_2321:focus {
    outline: none;
  }
  
  ._dot_1iakc_2321._active_1iakc_1543 {
    background: #000;
  }
  ...
  ._arrow_1iakc_2371:hover {
    color: rgb(230, 230, 230);
  }
  
  ._arrow--disabled_1iakc_2439,
  ._arrow--disabled_1iakc_2439:hover {
    color: rgba(255, 255, 255, 0.5);
  }
  
  ._navDotsMargin_1iakc_2449 {
    margin-top: 12px;
  }
  
  ._inactiveThumbnailBorderImgSlider_1iakc_2457 {
    border: 'solid transparent 2px';
  }
  
  ._ytVideoImgSlider_1iakc_2465 {
    width: 100%;
    height: 100%;
  }
  
  ._ytVideoImgSlider_1iakc_2465 iframe {
    width: 100%;
    height: 100%;
  }
  
  ._outerYTVideoImgSlider_1iakc_2485 {
    height: 100%;
  }
  
  ._lightboxjs_1iakc_1 iframe {
    margin: none;
    padding: none;
    border: none;
  }
  
  ._imgSliderArrow_1iakc_2505 {
    z-index: 100000;
    background-color: transparent;
    border: none;
  }
  ...
  ._cursorPointer_1iakc_2527 {
    cursor: pointer;
  }
  
  ._lightboxjsIcon_1iakc_2535 > * { color: inherit; fill: inherit }
  ...
  ._emblaViewport_1iakc_2555 {
    overflow: hidden;
    width: 100vw;
  }
  
  ._emblaContainer_1iakc_2565 {
  ...
  */
  ...
  ._emblaContainerImgMetadata_1iakc_2595 {
    width: 78vw;
    max-width: 78vw;
    height: 80vh;
  }
  
  ._imgdrag_1iakc_2607 ._emblaSlide_1iakc_2607 {
    flex: 0 0 80%;
    min-width: 0;
    max-width: 100%;
    padding-left: 12px;
  ...
  ._emblaThumbsViewport_1iakc_2627 {
    overflow: hidden;
  }
  
  ._emblaThumbsContainer_1iakc_2635 {
    display: flex;
    flex-direction: row;
  ...
  ._emblaThumbsContainer_1iakc_2635::before, ._emblaThumbsContainer_1iakc_2635::after {
    content: '';  /* Insert pseudo-element */
    margin: auto; /* Make it push flex items to the center */
  }
  
  
  ._emblaThumbsSlide_1iakc_2671 {
    /* min-width: 0; */
  ...
  ._emblaThumbsSlideImg_1iakc_2685 {
    /* display: block; */
  ...
  ._metadata_1iakc_2707 {
    color: white;
  }
  
  ._emblaSlideGrid_1iakc_2715 {
    display: flex;
  }
  ...
  ._metadataPanel_1iakc_2737 {
    display: flex;
    flex-direction: column;
    flex-wrap: wrap;
  }
  
  ._metadataInnerContainer_1iakc_2749 {
    padding-left: 7vw;
  }
  
  ._metadataInnerContainer_1iakc_2749 span {
    display: block;
  }
  
  
  ._imgMetadataCloseBtn_1iakc_2767 {
    position: absolute;
    top: 1%;
    right: 2%;
    background: none;
  ...
  ._reactTransformWrapper_1iakc_2789 {
    position: relative;
  ...
  ._reactTransformComponent_1iakc_1923 img {
    pointer-events: none;
  }
  
  ._navigationDot_1iakc_195 {
    height: 10px;
    width: 10px;
  ...
  ._navigationDotContainer_1iakc_2873 {
    padding-top: 24px;
    padding-bottom: 24px;
    padding-left: 12px;
    padding-right: 12px;
  ...
  ._imgfade_1iakc_2887._emblaContainer_1iakc_2565 {
    transform: none !important; /* override Embla */
    display: flex;
    /* height: 250px; */
  }

  ._notFullScreen_1iakc_2899 {
    top: 0;
  }
  
  ._imgfade_1iakc_2887._emblaSlide_1iakc_2607 {
    flex: 0 0 auto;
    width: 100%;
    height: 100%;
    position: absolute;
  ...
  ._imgFadeWithTopCaption_1iakc_2935 {
    top: 16%;
    position: fixed;
  }
  
  ._imgfade_1iakc_2887._emblaSlideSelected_1iakc_2945 {
    opacity: 1;
    transition: opacity 0.3s;
    z-index: 1;
  }
  
  ._imgfade_1iakc_2887._emblaSlide_1iakc_2607:before {
    position: absolute;
    top: 50%;
    left: 50%;
...
._rotateImg90Deg_1iakc_2983{
  transform: rotate(90deg);
  transition: transform 1s linear;
}  

._rotate_img_1iakc_2993 {
...
var SlideshowLightbox_module_css_default = { "lightboxjs": "_lightboxjs_1iakc_1", "slideshowContainer": "_slideshowContainer_1iakc_37", "slideshowBtn": "_slideshowBtn_1iakc_55", "closeIcon": "_closeIcon_1iakc_63", "iconsHeader": "_iconsHeader_1iakc_67", "prev1": "_prev1_1iakc_71", "next1": "_next1_1iakc_73", "icon": "_icon_1iakc_67", "prevIcon": "_prevIcon_1iakc_89", "nextIcon": "_nextIcon_1iakc_91", "show": "_show_1iakc_101", "displayHidden": "_displayHidden_1iakc_109", "thumbnail": "_thumbnail_1iakc_117", "hoverShadow": "_hoverShadow_1iakc_131", "thumbnails": "_thumbnails_1iakc_171", "thumbnailsWithCaption": "_thumbnailsWithCaption_1iakc_187", "navigationDots": "_navigationDots_1iakc_195", "imageSlide": "_imageSlide_1iakc_211", "thumbnailsOuterContainer": "_thumbnailsOuterContainer_1iakc_221", "thumbnailsAndCaption": "_thumbnailsAndCaption_1iakc_235", "hideControlsBar": "_hideControlsBar_1iakc_243", "slideshowImg": "_slideshowImg_1iakc_243", "rotateImgInnerContainer": "_rotateImgInnerContainer_1iakc_251", "slideshowInnerContainer": "_slideshowInnerContainer_1iakc_259", "videoThumbnailsOuterContainer": "_videoThumbnailsOuterContainer_1iakc_279", "imgTitleContainer": "_imgTitleContainer_1iakc_287", "thumbnailsOuterContainerMetadata": "_thumbnailsOuterContainerMetadata_1iakc_367", "htmlVideoOuterContainer": "_htmlVideoOuterContainer_1iakc_391", "caption": "_caption_1iakc_403", "galleryImg": "_galleryImg_1iakc_423", "modalContainer": "_modalContainer_1iakc_433", "slideshowAnimContainer": "_slideshowAnimContainer_1iakc_471", "fullScreenContainer": "_fullScreenContainer_1iakc_507", "imageInnerContainer": "_imageInnerContainer_1iakc_519", "magnifyWrapper": "_magnifyWrapper_1iakc_557", "slideshowInnerVideoContainer": "_slideshowInnerVideoContainer_1iakc_597", "slideshowInnerContainerThumbnails": "_slideshowInnerContainerThumbnails_1iakc_605", "lightboxContainer": "_lightboxContainer_1iakc_629", "slideshowAnimImg": "_slideshowAnimImg_1iakc_701", "controls": "_controls_1iakc_711", "ytVideo": "_ytVideo_1iakc_751", "videoOuterContainer": "_videoOuterContainer_1iakc_763", "customVideoContainer": "_customVideoContainer_1iakc_791", "customEmbedContainer": "_customEmbedContainer_1iakc_791", "videoIconsHeader": "_videoIconsHeader_1iakc_801", "lightbox": "_lightbox_1iakc_1", "imgTitle": "_imgTitle_1iakc_287", "innerContainerWithTopCaption": "_innerContainerWithTopCaption_1iakc_1073", "slideshowImgFullscreen": "_slideshowImgFullscreen_1iakc_1081", "slideshowInnerContainerFullScreen": "_slideshowInnerContainerFullScreen_1iakc_1125", "fullScreenLightboxImg": "_fullScreenLightboxImg_1iakc_1133", "slideshowInnerContainerImgMetadata": "_slideshowInnerContainerImgMetadata_1iakc_1145", "opacityFade": "_opacity-fade_1iakc_1199", "imageSliderThumbnails": "_imageSliderThumbnails_1iakc_1227", "slideshowImgMetadata": "_slideshowImgMetadata_1iakc_1303", "prev1Metadata": "_prev1Metadata_1iakc_1311", "slideshowImgWithCaption": "_slideshowImgWithCaption_1iakc_1353", "hideControlsBarAndCaption": "_hideControlsBarAndCaption_1iakc_1361", "lightboxImg": "_lightboxImg_1iakc_1379", "lightIcon": "_lightIcon_1iakc_1429", "darkIcon": "_darkIcon_1iakc_1455", "lightHeaderIcon": "_lightHeaderIcon_1iakc_1485", "darkHeaderIcon": "_darkHeaderIcon_1iakc_1511", "magnifierImage": "_magnifierImage_1iakc_1535", "active": "_active_1iakc_1543", "inactiveThumbnailBorder": "_inactiveThumbnailBorder_1iakc_1551", "emblaThumbs": "_emblaThumbs_1iakc_1567", "htmlVideo": "_htmlVideo_1iakc_391", "containImg": "_containImg_1iakc_1891", "reactTransformComponent": "_reactTransformComponent_1iakc_1923", "loader": "_loader_1iakc_1945", "rotation": "_rotation_1iakc_1", "dayLoader": "_dayLoader_1iakc_1991", "nightLoader": "_nightLoader_1iakc_2001", "closeButton": "_closeButton_1iakc_2023", "closeButtonRounded": "_closeButtonRounded_1iakc_2023", "slideImageAndCaption": "_slideImageAndCaption_1iakc_2117", "roundedBorder": "_roundedBorder_1iakc_2149", "maxWidthFull": "_maxWidthFull_1iakc_2157", "maxWidthWithoutMagnifier": "_maxWidthWithoutMagnifier_1iakc_2165", "lightboxVideo": "_lightboxVideo_1iakc_2303", "navigationWrapper": "_navigation-wrapper_1iakc_2313", "dots": "_dots_1iakc_2321", "dot": "_dot_1iakc_2321", "arrow": "_arrow_1iakc_2371", "leftArrow": "_leftArrow_1iakc_2401", "rightArrow": "_rightArrow_1iakc_2415", "arrowDisabled": "_arrow--disabled_1iakc_2439", "navDotsMargin": "_navDotsMargin_1iakc_2449", "inactiveThumbnailBorderImgSlider": "_inactiveThumbnailBorderImgSlider_1iakc_2457", "ytVideoImgSlider": "_ytVideoImgSlider_1iakc_2465", "outerYtVideoImgSlider": "_outerYTVideoImgSlider_1iakc_2485", "imgSliderArrow": "_imgSliderArrow_1iakc_2505", "cursorPointer": "_cursorPointer_1iakc_2527", "lightboxjsIcon": "_lightboxjsIcon_1iakc_2535", "embla": "_embla_1iakc_1567", "emblaViewport": "_emblaViewport_1iakc_2555", "emblaContainer": "_emblaContainer_1iakc_2565", "emblaContainerImgMetadata": "_emblaContainerImgMetadata_1iakc_2595", "imgdrag": "_imgdrag_1iakc_2607", "emblaSlide": "_emblaSlide_1iakc_2607", "emblaThumbsViewport": "_emblaThumbsViewport_1iakc_2627", "emblaThumbsContainer": "_emblaThumbsContainer_1iakc_2635", "emblaThumbsSlide": "_emblaThumbsSlide_1iakc_2671", "emblaThumbsSlideImg": "_emblaThumbsSlideImg_1iakc_2685", "mlAuto": "_mlAuto_1iakc_2699", "metadata": "_metadata_1iakc_2707", "emblaSlideGrid": "_emblaSlideGrid_1iakc_2715", "metadataPanel": "_metadataPanel_1iakc_2737", "metadataInnerContainer": "_metadataInnerContainer_1iakc_2749", "imgMetadataCloseBtn": "_imgMetadataCloseBtn_1iakc_2767", "reactTransformWrapper": "_reactTransformWrapper_1iakc_2789", "navigationDot": "_navigationDot_1iakc_195", "navigationDotContainer": "_navigationDotContainer_1iakc_2873", "imgfade": "_imgfade_1iakc_2887", "notFullScreen": "_notFullScreen_1iakc_2899", "imgFadeWithTopCaption": "_imgFadeWithTopCaption_1iakc_2935", "emblaSlideSelected": "_emblaSlideSelected_1iakc_2945", "fullImg": "_fullImg_1iakc_2971", "rotateImg90Deg": "_rotateImg90Deg_1iakc_2983", "rotateImg": "_rotate_img_1iakc_2993" };
...
var SlideshowLightbox = React.forwardRef(
  (props, ref) => {
    ...
    const regularImgPaneNodes = Array.apply(null, Array(images.length)).map(
      (_, index) => {
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `${props.fullScreen ? SlideshowLightbox_module_css_default.fullScreenContainer : null}`, children: enableMagnifyingGlass == true ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "div",
          {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `${initWrapperClassname()}`, children: [
      renderPreviewImages(),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { initial: false, mode: "wait", children: showModal !== false && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_portal.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_div_100vh.default, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                        ...
                        ${isImageCaption("below") && showControlsBar == true ? SlideshowLightbox_module_css_default.slideImageAndCaption : ""} 
                          ...
                          ${displayImgMetadata ? SlideshowLightbox_module_css_default.slideshowInnerContainerImgMetadata : ""}  `,
                            ...
                            ${displayImgMetadata ? SlideshowLightbox_module_css_default.emblaContainerImgMetadata : ""}`,
                                  style: props.fullScreen == true ? { height: "100vh" } : {},
