...
// esbuild-css-modules-plugin-namespace:C:\Users\silvi\AppData\Local\Temp\tmp-8164-pnyeq7iMRbNk\lightbox.js-react\src\components\SlideshowLightbox\SlideshowLightbox.module.css.js
...
var SlideshowLightbox = React.forwardRef(
  (props, ref) => {
    ...
    const regularImgPaneNodes = Array.apply(null, Array(images.length)).map(
      (_, index) => {
        return /* @__PURE__ */ jsx("div", { className: `${props.fullScreen ? SlideshowLightbox_module_css_default.fullScreenContainer : null}`, children: enableMagnifyingGlass == true ? /* @__PURE__ */ jsx("div", {}) : /* @__PURE__ */ jsx(
          "div",
          {
    ...
    return /* @__PURE__ */ jsxs("div", { className: `${initWrapperClassname()}`, children: [
      renderPreviewImages(),
      /* @__PURE__ */ jsx(AnimatePresence, { initial: false, mode: "wait", children: showModal !== false && /* @__PURE__ */ jsx(Portal, { children: /* @__PURE__ */ jsx(Div100vh, { children: /* @__PURE__ */ jsxs(
        motion.div,
        {
...
//# sourceMappingURL=chunk-PQWWB3HL.mjs.map